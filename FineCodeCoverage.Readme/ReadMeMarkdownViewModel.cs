...
namespace FineCodeCoverage.Readme
{
    ...
    internal sealed class ReadMeMarkdownViewModel : ObservableBase
    {
        ...
        public ReadMeMarkdownViewModel(
            IProcess process,
            ITemplatedReadmeProvider templatedReadmeProvider,
        ...
        {
            _templatedReadmeProvider = templatedReadmeProvider;
        ...
        {
            TemplatedReadmeInfo templatedReadmeInfo = _templatedReadmeProvider.GetTemplatedReadme();
