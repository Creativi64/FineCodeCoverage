...
namespace FineCodeCoverage.Output
{
    ...
    internal sealed class OpenHotspotsCommand : CommandInitializerBase, IListener<ReportFilesMessage>, IListener<OutdatedOutputMessage>
    {
        ...
        private readonly IHotspotsWriter _hotspotsService;
        ...
        public OpenHotspotsCommand(IEventAggregator eventAggregator, IHotspotsWriter hotspotsService, IVsOpenFile vsOpenFile)
        {
