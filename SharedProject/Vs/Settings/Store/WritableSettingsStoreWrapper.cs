...
namespace FineCodeCoverage.Options
{
    internal sealed class WritableSettingsStoreWrapper : IWritableSettingsStore
    {
        ...
        public int GetInt32(string collectionPath, string propertyName) => _store.GetInt32(collectionPath, propertyName);
        ...
        public void SetInt32(string collectionPath, string propertyName, int value) => _store.SetInt32(collectionPath, propertyName, value);
