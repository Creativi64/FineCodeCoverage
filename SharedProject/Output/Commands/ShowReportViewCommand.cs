...
namespace FineCodeCoverage.Output
{
    ...
    internal sealed class ShowReportViewCommand : CommandInitializerBase
    {
        ...
        public ShowReportViewCommand(IReportViewService reportViewService) => this.reportViewService = reportViewService;

        protected override void Execute(object sender, EventArgs e) => this.reportViewService.Show();
    }
}