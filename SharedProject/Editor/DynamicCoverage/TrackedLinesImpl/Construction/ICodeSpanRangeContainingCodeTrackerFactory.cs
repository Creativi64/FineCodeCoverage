...
namespace FineCodeCoverage.Editor.DynamicCoverage
{
    internal interface ICodeSpanRangeContainingCodeTrackerFactory
    {
        ...
        IContainingCodeTracker CreateCoverageLines(ITextSnapshot textSnapshot, List<ICoberturaLine> lines, CodeSpanRange containingRange, SpanTrackingMode spanTrackingMode);
