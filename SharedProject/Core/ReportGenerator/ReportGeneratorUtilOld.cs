...
{
	interface IReportGeneratorUtilOld
    {
		...
		Task<ReportGeneratorResultOld> GenerateAsync(IEnumerable<string> coverOutputFiles,string reportOutputFolder,CancellationToken cancellationToken);
        string BlankReport(bool withHistory);
        void LogCoverageProcess(string message);
		void EndOfCoverageRun();
    }

    internal class ReportGeneratorResultOld
	{
	...
	[Export(typeof(IReportGeneratorUtilOld))]
	internal partial class ReportGeneratorUtilOld : 
		IReportGeneratorUtilOld, 
...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
        public async Task<ReportGeneratorResultOld> GenerateAsync(IEnumerable<string> coverOutputFiles, string reportOutputFolder, CancellationToken cancellationToken)
